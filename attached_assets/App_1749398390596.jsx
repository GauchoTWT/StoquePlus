        ...
        <AnimatePresence>
          {selectedProduct && (
            ...
            >
              ...
              >
                <h3 className="text-2xl font-bold text-white mb-4">Detalhes do Item</h3>
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-slate-400 text-sm">Lote</p>
                    <p className="text-white">{selectedProduct.batch}</p>
                  </div>
                  {selectedProduct.expirationDate && (
                    <div>
                      <p className="text-slate-400 text-sm">Data de Validade</p>
                      <p className="text-white">{new Date(selectedProduct.expirationDate).toLocaleDateString('pt-BR')}</p>
                    </div>
                  )}
                  <div>
                    <p className="text-slate-400 text-sm">Última Atualização</p>
                    <p className="text-white">{new Date(selectedProduct.lastUpdated).toLocaleString('pt-BR')}</p>
                  </div>
                </div>
                <Button 
                  onClick={() => setSelectedProduct(null)}
                  className="w-full mt-6 bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600"
                >
                  Fechar
                </Button>
              </motion.div>
